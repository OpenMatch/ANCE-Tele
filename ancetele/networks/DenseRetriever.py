...
#             ## *************************************************
#             ## SS Testing (None-in-batch)
#             p_reps=p_reps.view((effective_bsz, self.data_args.train_n_passages, 768))
#             scores = torch.sum(q_reps.unsqueeze(1) * p_reps, dim=-1)
...
#             scores = scores.view(effective_bsz, -1) ## 0510-before
...
#             target = target * self.data_args.train_n_passages ## 0510-before
