...
## *************************************
## INPUT
export train_job_name=epi-1.ance-tele.co-condenser-marco.checkpoint-20000
...
export prev_combine_file_name=qry-pos-neg.co-condenser-marco
export final_output_file_name=epi-1-20k.combin-prev.qry-pos-neg.co-condenser-marco
## *************************************
## *************************************
