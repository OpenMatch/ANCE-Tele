...
## *************************************
## INPUT
export train_job_name=epi-2.ance-tele.co-condenser-marco.checkpoint-20000
...
export prev_combine_file_name=epi-1-20k.combin-prev.qry-pos-neg.co-condenser-marco
export final_output_file_name=epi-2-20k.combin-prev.qry-pos-neg.co-condenser-marco
## *************************************
## *************************************
...
## *************************************
CUDA_VISIBLE_DEVICES=${CUDAs[0]} python ../encode.py \
--output_dir ${OUTPUT_DIR}/${infer_job_name} \
--model_name_or_path ${OUTPUT_DIR}/${train_job_name} \
--fp16 \
--per_device_eval_batch_size 2048 \
...
python ../preprocess/combine_negative/combine_negative.py \
--data_dir ${DATA_DIR}/${TOKENIZER_ID} \
--input_folder_1 ${new_combine_file_name} \
--input_folder_2 ${prev_combine_file_name} \
--output_folder ${final_output_file_name} \