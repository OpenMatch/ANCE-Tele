...
## *************************************
## INPUT/OUTPUT
export train_job_name=epi-2.ance-tele.triviaqa.checkp-2000
...
export mom_tele_file_name=epi-2-tele-neg.triviaqa
export new_tele_file_name=epi-3-tele-neg.triviaqa
## *************************************
...
--queries ${DATA_DIR}/triviaqa-train-qrels.jsonl \
