...
export train_data=qry-pos-neg.co-condenser-marco
## OUTPUT
export train_job_name=epi-1.ance-tele.co-condenser-marco
...
## The results obtained with the following two hyper-parameters are similar. For faster speed, train_n_passages=16 can be used directly here.
## --train_n_passages 16 \
## --train_n_passages 32 \
